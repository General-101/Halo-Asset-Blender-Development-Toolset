"""
Python code generation for models defined with ..model
"""
...
class Grammar(Base):
    ...
    template = '''\
                ...
                from ..parsing import tatsumasu
                from ..parsing import leftrec, nomemo, isname # noqa
                from ..util import re, generic_main  # noqa
